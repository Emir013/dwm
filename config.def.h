...
static const char *fonts[]          = { "DejavuSansMono Nerd Font:size=7:antialias=true:autohint=true" };
static const char dmenufont[]       = "DejavuSansMono Nerd Font:size=11:antialias=true:autohint=true";
...
static const char col_cyan[]        = "#ebebeb";
...
/* tagging */
static const char *tags[] = { "ett", "två", "tre", "fyra", "fem", "sex" };
